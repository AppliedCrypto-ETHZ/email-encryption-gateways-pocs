...
def main():
    ...
    encrypted_msg['From'] = "smime1@internal.test"
    ...
    outer_msg['From'] = "temp@external.test"
    outer_msg['To'] = "smime1@internal.test"
    outer_msg['Subject'] = "Outer Message - Will be bounced anyway"

    print(client.sendmail("temp@external.test", ["smime1@internal.test"], outer_msg.as_string()))
    print(client.quit())
